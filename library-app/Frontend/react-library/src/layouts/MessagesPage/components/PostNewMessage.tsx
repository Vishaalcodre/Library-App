            ...
            <div className="card-body">
                <form method="POST">
                    ...
                    <div className="mb-3">
                        ...
                        <textarea className="form-control" name="" id="exampleFormControlTextarea1" rows={3}
                            onChange={e => setQuestion(e.target.value)} value={question}
                        ></textarea>
                    </div>
                    <div>
                        <button className="btn btn-primary mt-3" onClick={submitNewQuestion} type="button">
                            Submit Question
                        </button>
                    </div>
                </form>
